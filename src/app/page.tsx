    ...
    <>
      ...
      <section className="bg-surface-dark px-6 md:px-10 py-20 md:py-28">
        <div className="mx-auto max-w-3xl">
          <p className="font-display font-light text-xl md:text-2xl leading-relaxed text-ink-on-dark">
      ...
      <section className="px-6 md:px-10 py-20 md:py-28">
        <div className="mx-auto max-w-6xl">
          <h2 className="font-display font-light text-2xl md:text-3xl text-ink mb-12">
            Services
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            {[
              ...
              <div key={group.title}>
                <h3 className="font-display font-light text-lg text-ink mb-4">
                  {group.title}
                </h3>
      ...
      {/* Contact CTA */}
      <section className="bg-surface-dark px-6 md:px-10 py-16 md:py-20 flex flex-col md:flex-row md:items-center md:justify-between gap-8">
        <h2 className="font-display font-light text-2xl md:text-3xl text-ink-on-dark max-w-md">
